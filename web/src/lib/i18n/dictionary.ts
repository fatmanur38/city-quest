...
const en = {
  ...
  institution: {
    ...
    cameraPaused: "Camera paused — close the last result to scan again",
...
const tr: Dictionary = {
  ...
  institution: {
    ...
    cameraPaused: "Kamera duraklatıldı — tekrar okutmak için sonucu kapat",
    nextVisitor: "Sıradaki ziyaretçi",
